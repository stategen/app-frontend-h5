...
export class Topic_detail_$topicIdCommand extends BaseCommand {
  ...
  static * PostReply_effect({payload}, {call, put, select}) {
    ...
    const topicReplys = updateArray(oldTopicReplyArea.list, topicReply, "replyId");
  ...
  static * getTopicReplyPageList_effect({payload}, {call, put, select}) {
    ...
    const pagination =topicReplyPageList!.pagination;
    const topicReplys = updateArray(oldTopicReplyArea.list, topicReplyPageList!.items, "replyId");
